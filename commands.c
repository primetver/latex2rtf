...
/* sectioning commands */
    ...
    {"cleardoublepage", CmdNewPage, NewSection},
    ...
    {"printnomenclature", CmdPrintnomenclature, 0},
    {"printglossary", CmdPrintnomenclature, 0},
    ...
    {"Alph", CmdAlphaRoman, ALPHA_UPPER},
    {"alph", CmdAlphaRoman, ALPHA_LOWER},
    {"Roman", CmdAlphaRoman, ROMAN_UPPER},
    {"roman", CmdAlphaRoman, ROMAN_LOWER},
...
static CommandArray PreambleCommands[] = {
    ...
    {"titlefoot", CmdTitleHeadFoot, 1},
    {"titlehead", CmdTitleHeadFoot, 0}, 
...
static CommandArray params[] = {
    ...
    {"thenomenclature", CmdThenomenclature, 0},
